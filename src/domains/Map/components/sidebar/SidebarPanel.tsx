    ...
    >
      ...
      {index === 1 && isDetail && (
        <button
          ...
          className="absolute active:scale-95 active:opacity-80 z-10 left-2  md:left-[100%] top-8 md:top-2 w-10 md:h-12 md:border-l-0 h-10 md:top-[43%] cursor-pointer hover:bg-gray-100 focus:outline-none bg-white border-1  md:rounded-lg rounded-full border-gray-200"
        >
          <ChevronLeft
