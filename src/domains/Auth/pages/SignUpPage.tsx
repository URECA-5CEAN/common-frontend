  ...
  return (
    <div className="min-h-screen pt-[62px] md:pt-[86px] bg-white relative">
      <style>{`
        ...
        .wave-animation-1 {
          animation: waveSlideRight 1s ease-out 0.1s both;
        }
        
        .wave-animation-2 {
          animation: waveSlideRight 1s ease-out 0.3s both;
        }
        
        .wave-animation-3 {
          animation: waveSlideRight 1s ease-out 0.5s both;
        }
      ...
      <div className="absolute inset-0 z-0 min-h-full">
        ...
        <div className="block md:hidden">
          ...
          <div className="absolute left-0 bottom-0 w-full h-[60vh] max-h-[60vh] mobile-wave-animation-1">
            <img
              src={mobileWave1}
              alt="Mobile Wave 1"
          ...
          <div className="absolute left-0 bottom-0 w-full h-[50vh] max-h-[50vh] mobile-wave-animation-2">
            <img
              src={mobileWave2}
              alt="Mobile Wave 2"
              className="w-full h-full object-cover object-bottom"
          ...
          <div className="absolute left-0 bottom-0 w-full h-[50vh] max-h-[50vh] mobile-wave-animation-3">
            <img
              src={mobileWave3}
              alt="Mobile Wave 3"
              className="w-full h-full object-cover object-bottom"
        ...
        <div className="hidden md:block min-h-full">
          ...
          <div className="absolute right-0 top-0 w-3/5 min-h-screen h-full wave-animation-1">
            <img
              src={sideWave1}
              alt="Side Wave 1"
              className="w-full h-full min-h-screen object-cover object-right transform scale-x-[-1]"
            />
          </div>

          {/* Side Wave 2 - 두 번째 레이어 */}
          <div className="absolute right-0 top-0 w-2/5 min-h-screen h-full wave-animation-2">
            <img
              src={sideWave2}
              alt="Side Wave 2"
              className="w-full h-full min-h-screen object-cover object-right transform scale-x-[-1]"
          ...
          <div className="absolute right-0 top-0 w-1/5 min-h-screen h-full wave-animation-3">
            <img
              src={sideWave3}
              alt="Side Wave 3"
              className="w-full h-full min-h-screen object-cover object-right transform scale-x-[-1]"
      ...
      {/* 폼 - 파도 위에 표시 */}
      <div className="relative z-[5] min-h-[calc(100vh-62px)] md:min-h-[calc(100vh-86px)] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8">
        <div
          className="w-[90%] 
            sm:w-[85%] 
            md:w-[75%] 
