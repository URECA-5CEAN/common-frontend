...
const STYLES = {
  calendarWrapper: 'w-full flex mb-10',
  calendarContainer:
    'bg-white w-full h-[624px] md:h-[648px] md:max-w-[463px] border border-gray-200 rounded-xl p-3 pb-6 md:p-[30px] flex flex-col items-center justify-between',
